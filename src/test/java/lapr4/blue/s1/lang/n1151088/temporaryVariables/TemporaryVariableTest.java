...
public class TemporaryVariableTest {
    ...
    /**
     * Test of evaluate method, of class TemporaryVariable.
     * @throws java.lang.Exception
     */
    @Test
    public void testEvaluate() throws Exception {
        System.out.println("evaluate");
        TemporaryVariable instance = new TemporaryVariable("_test", exp1);
    ...
    public void testGetName() {
        ...
        String test="test";
        TemporaryVariable instance = new TemporaryVariable(test, exp1);
    ...
    /**
     * Test of getExpression method, of class TemporaryVariable.
    ...
    public void testEqualsValid() throws IllegalValueTypeException {
        ...
        TemporaryVariable instance2= new TemporaryVariable(test,  exp2);
    ...
    public void testEqualsInvalid() throws IllegalValueTypeException {
        ...
        String test2="test2";
        TemporaryVariable instance2= new TemporaryVariable(test2, exp2);
