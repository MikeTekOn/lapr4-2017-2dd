...
/**
 * It tests the TypeComparatorDTN comparator.
 *
 * @author Manuel Meireles (1150532)
 */
public class TypeComparatorDTNTest {

    /**
     * The testing comparator.
     */
    private final TypeComparatorDTN comparator;
     ...
     * comparator.
     */
    public TypeComparatorDTNTest() {
        comparator = new TypeComparatorDTN();
    }

    /**
     * It ensures that TypeComparatorDTN guarantees that Text is the greater
    ...
    /**
     * It ensures that TypeComparatorDTN guarantees that Numeric Type is the
     * greater type.
     */
    @Test
    ...
    /**
     * It ensures that TypeComparatorDTN guarantees that Date is the greater
