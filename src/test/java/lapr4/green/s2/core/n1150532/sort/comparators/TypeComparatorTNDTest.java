...
/**
 * It tests the TypeComparatorTND comparator.
 *
 * @author Manuel Meireles (1150532)
 */
public class TypeComparatorTNDTest {

    /**
     * The testing comparator.
     */
    private final TypeComparatorTND comparator;
     ...
     * comparator.
     */
    public TypeComparatorTNDTest() {
        comparator = new TypeComparatorTND();
    }

    /**
     * It ensures that TypeComparatorTND guarantees that Text is the greater
     * type except for the Date and Numeric Types.
     */
    @Test
    ...
    /**
     * It ensures that TypeComparatorTND guarantees that Numeric Type is the
     * greater type except for the Date Type.
     */
    @Test
    ...
    /**
     * It ensures that TypeComparatorTND guarantees that Date is the greater
     * type.
     */
    @Test
