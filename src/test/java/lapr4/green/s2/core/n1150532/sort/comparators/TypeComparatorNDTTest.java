...
/**
 * It tests the TypeComparatorNDT comparator.
 *
 * @author Manuel Meireles (1150532)
 */
public class TypeComparatorNDTTest {

    /**
     * The testing comparator.
     */
    private final TypeComparatorNDT comparator;
     ...
     * comparator.
     */
    public TypeComparatorNDTTest() {
        comparator = new TypeComparatorNDT();
    }

    /**
     * It ensures that TypeComparatorNDT guarantees that Text is the greater
     * type.
     */
    @Test
    ...
    /**
     * It ensures that TypeComparatorNDT guarantees that Numeric Type is the greater
     * type except for the Date and Text Types.
     */
    @Test
    ...
    /**
     * It ensures that TypeComparatorNDT guarantees that Date is the greater
