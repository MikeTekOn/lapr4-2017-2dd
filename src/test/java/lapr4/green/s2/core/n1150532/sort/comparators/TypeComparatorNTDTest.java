...
/**
 * It tests the TypeComparatorNTD comparator.
 *
 * @author Manuel Meireles (1150532)
 */
public class TypeComparatorNTDTest {

    /**
     * The testing comparator.
     */
    private final TypeComparatorNTD comparator;
     ...
     * comparator.
     */
    public TypeComparatorNTDTest() {
        comparator = new TypeComparatorNTD();
    }

    /**
     * It ensures that TypeComparatorNTD guarantees that Text is the greater
     * type except for the Date Type.
     */
    @Test
    ...
    /**
     * It ensures that TypeComparatorNTD guarantees that Numeric Type is the
     * greater type except for the Date and Text Types.
     */
    @Test
    ...
    /**
     * It ensures that TypeComparatorNTD guarantees that Date is the greater
     * type.
     */
    @Test
