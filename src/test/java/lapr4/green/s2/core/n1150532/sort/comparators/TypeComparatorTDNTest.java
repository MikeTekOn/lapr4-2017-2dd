...
/**
 * It tests the TypeComparatorTDN comparator.
 *
 * @author Manuel Meireles (1150532)
 */
public class TypeComparatorTDNTest {

    /**
     * The testing comparator.
     */
    private final TypeComparatorTDN comparator;
     ...
     * comparator.
     */
    public TypeComparatorTDNTest() {
        comparator = new TypeComparatorTDN();
    }

    /**
     * It ensures that TypeComparatorTDN guarantees that Text is the greater
    ...
    /**
     * It ensures that TypeComparatorTDN guarantees that Numeric Type is the
     * greater type.
     */
    @Test
    ...
    /**
     * It ensures that TypeComparatorTDN guarantees that Date is the greater
     * type except for the Numeric Type.
     */
    @Test
