...
public class Grid extends JTable {
    ...
    /**
     * Processes key bindings in the table. Overridden to prevent modified key
     * events from invoking the editor.
     */
    ...
    /**
     * Changes the current selection in the table. Overridden to repaint row and
 ...
 * ROW HEADER
     ...
     * component.
     *
     * @param header the component to use as the row header, or null if no
     * header is wanted
     */
    private void setEnclosingScrollPaneRowHeaderView(JComponent header) {
        ...
        if (getParent() instanceof JViewport) {
            if (getParent().getParent() instanceof JScrollPane) {
                ...
                if (viewport != null && viewport.getView() == this) // Updates row header
                {
