 ...
 * methods to ensure that the Numeric Type is the greater, followed by the Text
 * and Date. All others will be lesser.
 *
 * @author Manuel Meireles (1150532)
 */
public class TypeComparatorDTN extends TypeComparator {

    /**
     * The name of the comparator. It describes the values hierarchy.
     */
    private static final String NAME = "Date < Text < Numeric";

    /**
     * The full constructor of the comparator. It is protected to force the use
     * of the factory.
     */
    protected TypeComparatorDTN() {
        super();
    }
     ...
     * than all other types, except for Numeric Types which is greater than Text
     ...
     * than all other types, except for Numeric and Text Types which are greater
     ...
     * TypeComparatorDTN or "false" otherwise.
     */
    @Override
