 ...
 * methods to ensure that the Text Type is the greater, followed by the Date and
 * Numeric. All others will be lesser.
 *
 * @author Manuel Meireles (1150532)
 */
public class TypeComparatorNDT extends TypeComparator {

    /**
     * The name of the comparator. It describes the values hierarchy.
     */
    private static final String NAME = "Numeric < Date < Text";

    /**
     * The full constructor of the comparator. It is protected to force the use
     * of the factory.
     */
    protected TypeComparatorNDT() {
        super();
    }
     ...
     */
    @Override
    protected int numericComparisonTo(Value.Type other) {
        int comparison;
        switch (other) {
            case NUMERIC:
                comparison = EQUAL;
     ...
     */
    @Override
    protected int textComparisonTo(Value.Type other) {
        int comparison;
        switch (other) {
            case NUMERIC:
                comparison = GREATER;
     ...
     * than all other types, except for Text Types which are greater than Date
     ...
     */
    @Override
    protected int dateComparisonTo(Value.Type other) {
        int comparison;
        switch (other) {
            case NUMERIC:
                comparison = GREATER;
     ...
     * TypeComparatorNDT or "false" otherwise.
     */
    @Override
