 ...
 * methods to ensure that the Date Type is the greater, followed by the Text and
 * Numeric. All others will be lesser.
 *
 * @author Manuel Meireles (1150532)
 */
public class TypeComparatorNTD extends TypeComparator {

    /**
     * The name of the comparator. It describes the values hierarchy.
     */
    private static final String NAME = "Numeric < Text < Date";

    /**
     * The full constructor of the comparator. It is protected to force the use
     * of the factory.
     */
    protected TypeComparatorNTD() {
        super();
    }

    /**
     * It compares a Numeric type to other type. It ensures that it returns
     * greater than all other types, except for Date and Text Types which are
     * greater than Numeric Type, and equal if the other type is also a Numeric
     * Type.
     *
     ...
     * than all other types, except for Date Types which is greater than Text
     * Type, and equal if the other type is also a Text Type.
     *
     * @param other The other type to compare.
     * @return It returns -1, 0 or 1 depending on if the one type is lesser,
     * equal or greater the the other.
     ...
     * than all other types and equal if the other type is also a Date Type.
     *
     * @param other The other type to compare.
     * @return It returns 0 or 1 depending on if the other type is Date or not.
     */
    @Override
     ...
     * TypeComparatorNTD or "false" otherwise.
     */
    @Override
