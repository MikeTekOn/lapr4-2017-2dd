 ...
 * methods to ensure that the Date Type is the greater, followed by the Numeric
 * and Text. All others will be lesser.
 *
 * @author Manuel Meireles (1150532)
 */
public class TypeComparatorTND extends TypeComparator {

    /**
     * The name of the comparator. It describes the values hierarchy.
     */
    private static final String NAME = "Text < Numeric < Date";

    /**
     * The full constructor of the comparator. It is protected to force the use
     * of the factory.
     */
    protected TypeComparatorTND() {
        super();
    }

    /**
     * It compares a Numeric type to other type. It ensures that it returns
     * greater than all other types, except for Date Type which is greater than
     ...
     * TypeComparatorTND or "false" otherwise.
     */
    @Override
